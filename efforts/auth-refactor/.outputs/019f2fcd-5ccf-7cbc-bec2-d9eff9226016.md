...
`efforts/auth-refactor/.outputs/019f2fb4-4adf-79a5-bab4-a0b51709881a.md` to
...
`efforts/auth-refactor/.proofs/`) and then `gogglebox-approver` for criteria
2, 5, and 6.
...
into the relevant `.proofs/*.md` docs for criteria 2, 5, and 6, then
