...
output_path: efforts/auth-refactor/.outputs/019f2fdc-11a5-7efd-ac59-5d17f3e8b0a1.md
...
`efforts/auth-refactor/.proofs/` itself** (not gitignored) and reference that
copied path from the proof doc — never the ephemeral `./artifacts` path.

## What to close

1. **Criterion 2** — update
   `efforts/auth-refactor/.proofs/019f2aa8-4931-7a1c-86ba-4785a38163c3.md` to
   ...
   `.proofs/`, update the doc.
2. **Criterion 5** — update
   `efforts/auth-refactor/.proofs/019f2aa8-4936-7965-b407-de265936e392.md` with
   the new mixed-warning modal screenshot, copied into `.proofs/`.
3. **Criterion 6** — update
   `efforts/auth-refactor/.proofs/019f2aa8-4937-78c2-84fc-7c0eadca4372.md` to
   ...
   `.proofs/`, and update the doc to state clearly that both sandbox and UAT
...
`efforts/auth-refactor/.outputs/019f2fdc-11a5-7efd-ac59-5d17f3e8b0a1.md`.
