...
output_path: efforts/release-e2e-gate/.outputs/019f301a-1c2b-75ac-be64-a8f5e4d4ff49.md
...
to `efforts/release-e2e-gate/.outputs/019f301a-1c2b-75ac-be64-a8f5e4d4ff49.md`.
...
code confirmation). Do not write proof files under `.proofs/` yourself —
