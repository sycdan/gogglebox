...
4. [ ] [proof](./.proofs/019943aa-1a1e-7f83-b4e1-9a6d2c8f5b34.md) that the `e2e` job uploads `./artifacts/**` as a build artifact when the flow run fails, and that this artifact is confirmed retrievable from a real (or dry-run) Actions run showing the failure screenshots.
