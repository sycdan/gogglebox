...
prompt: .prompts/019f3491-2b35-7496-a997-21520e6c01a3.md
---
...
`efforts/party-compat-test-coverage/.proofs/.gitkeep` since no proofs exist
yet.

## Research performed

- Read both cited `rename-group-to-party` output files in full
  (`.outputs/019f33e2-5c9b-73fc-8082-3ec70b50e197.md` — verifier findings
  that first flagged both gaps; `.outputs/019f3452-31cb-7fcd-86a4-09afea62bbaf.md`
...
sort in AC order under `.proofs/`) rather than generated by the actual
...
- `efforts/party-compat-test-coverage/PartyCompatTestCoverage.md` (rewritten,
  was stub)
- `efforts/party-compat-test-coverage/.proofs/.gitkeep` (new, placeholder)
