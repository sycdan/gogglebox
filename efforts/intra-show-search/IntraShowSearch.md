...
3. [ ] [proof](./.proofs/6ec71891-3e87-4502-86cb-392888244222.md) that keyword search filters episodes across seasons by episode title and available episode metadata, with a clear empty state when nothing matches.
4. [ ] [proof](./.proofs/3894f19d-9296-4a3d-bdc9-e1c30b59e961.md) that each visible episode row shows the watched or unwatched state for every watcher in the active group.
