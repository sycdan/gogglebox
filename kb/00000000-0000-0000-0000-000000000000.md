...
If you are an _omniengineer_, you must now proceed with the work you were
prompted to do (in `**/.prompts/<prompt-id>.md`), otherwise you must read
[this](00000000-0000-0000-0000-100000000000.md) for further instructions.
